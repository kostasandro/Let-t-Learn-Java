...
?>
    <div class="container second-menu">
        ...
        <div class="row" style="margin-bottom:20px">
            <div class="col">
                <a href="levelDetails.php?level_id=<?php echo $level_id ?>" class="small">
            ...
            <div class="col text-center">
                <a href="levelTheory.php?level_id=<?php echo $level_id ?>" class="small">
            ...
            <div class="col text-center">
                <a href="levelExercises.php?level_id=<?php echo $level_id ?>" class="small">
            ...
            <div class="col <?php echo empty($question_id) ? 'text-right' : 'text-center' ?>">
                <a href="levelQuestions.php?level_id=<?php echo $level_id ?>" class="small">
            ...
            <?php if (!empty($question_id)) { ?>
                <div class="col text-right">
                    <a href="levelAnswers.php?level_id=<?php echo $level_id ?>&question_id=<?php echo $question_id ?>" class="small">
